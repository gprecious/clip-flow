        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="mt-4 text-sm text-neutral-500 dark:text-neutral-400">
              {t('inspector.noFileSelected', 'Select a file to view its script')}
            </p>
          </div>
        </div>
      </div>
    ...
    <div className="px-4 py-3 border-b border-neutral-200 dark:border-neutral-700 space-y-3">
      <div className="flex items-start gap-3">
        ...
        <div className="w-10 h-10 rounded-lg bg-primary-100 dark:bg-primary-900/30 flex items-center justify-center flex-shrink-0">
          {isVideo ? (
            <svg className="w-5 h-5 text-primary-600 dark:text-primary-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="text-center max-w-xs">
          ...
          <p className="text-xs text-neutral-400 mt-2">
            {t('inspector.pendingHint', 'Verifying Whisper availability and models')}
          </p>
        </div>
      </div>
    );
    ...
    return (
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="text-center w-full max-w-xs">
          ...
          <Progress value={file.progress} max={100} size="md" className="mb-2" />
